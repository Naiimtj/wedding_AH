...
const Place = () => {
  ...
  return (
    <div className="flex flex-col items-center gap-y-8 text-blueLightWedding dark:text-blueWedding">
        ...
        <div className="absolute top-0 left-0 w-full h-full flex flex-col items-center justify-center text-white">
          <div className="flex flex-col items-center gap-8">
            ...
            <div className="font-bold text-center">
              <div className="text-3xl font-semibold">{t('21:30 - 6:00')}</div>
              <div className="text-xl font-semibold">
                {t('Sí... toda la noche')}
              </div>
            </div>
          </div>
          <div className="border-t border-blueWedding w-60 my-16"></div>
          ...
          <div className="flex flex-col items-center gap-8">
            ...
            <div
              className="text-center text-2xl cursor-pointer hover:text-blueWedding transition duration-300"
              onClick={() =>
                window.open(
      ...
      <div className="relative w-3/4 h-96 my-10">
        <iframe
