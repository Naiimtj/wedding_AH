...
const GiftContent = () => {
  ...
  const copyToClipboard = (text) => {
    navigator.clipboard
      .writeText(text)
      .then(() => {
        alert(t('Texto copiado al portapapeles'));
      })
      .catch(() => {
        alert(t('Error al copiar el texto'));
      });
  };
  return (
    <div className="flex flex-col items-center gap-y-8 text-blueLightWedding dark:text-blueWedding">
      ...
      <div className="relative flex flex-col items-center justify-center w-2/3 h-96">
        <div className="absolute flex flex-col justify-between gap-4 text-2xl text-blueLightWedding border border-blueWedding shadow-xl text-center w-full p-8 rounded-xl">
          <div className="flex flex-col items-center">
            ...
            <div className="flex items-center justify-between p-4 font-normal rounded-xl border border-blueWedding w-2/3">
              ...
              <button
                className="text-blueLightWedding"
                onClick={() => copyToClipboard('ES04 2100 2383 2801 0018 7780')}
