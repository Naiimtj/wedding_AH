  ...
  return (
    <div className="relative flex flex-col items-center justify-center gap-y-8 mt-8">
      <img
        ...
        src={'/Hotel-Z.webp'}
        alt={'Picture Hadil & Álex'}
      />
      <div className="text-2xl text-blueLightWedding bg-blueWedding/10 text-center w-3/4 p-8 rounded-xl">
        ...
        a unos 8km del sitio de la boda. Es un hotel perfectamente equipado y
        cómodo.
      </div>
      <button
        onClick={() =>
